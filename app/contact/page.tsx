        ...
        <div className="bg-white border border-[#f3f4f6] rounded-2xl shadow-xl">
          <div className="p-8 md:p-10">
            ...
            <form className="space-y-5">
              ...
              <button className="w-full h-12 px-8 rounded-lg bg-green-600 text-white font-semibold hover:bg-green-700 transition-colors shadow-lg hover:shadow-green-500/25">
                Submit Request →
              </button>
            </form>
          </div>
