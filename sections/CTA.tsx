...
const CTA = () => {
  ...
  return (
    <section className="py-12 bg-gradient-to-r from-primary-600 to-primary-700 content-visibility-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-dark-600 mb-6">
                Don&apos;t miss out on government subsidies. Install solar now and save up to ₹78,000 on a 5kW system.
              </p>
